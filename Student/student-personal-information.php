					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<form action="student-personal-information.php" method="post">
							...
							<div class="row">
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputEmail1">Total Marks (HSC/A Levels):</label>
										<input type="number" name="total_marks" class="form-control" placeholder="Marks" value=<?php echo $row['total_marks'] ?>>
									</div>
								</div>
								<div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">Obtained Marks (HSC/A Levels):</label>
							...
							<div class="row">
								<div class="col-md-6 pr-5">
									<div class="form-group">
										...
										<input type="text" name="state" class="form-control" placeholder="Enter blood group" value=<?php echo $row['state'] ?>>
									</div>
								</div>
								<div class="col-md-6 pr-5">
									<div class="form-group">
