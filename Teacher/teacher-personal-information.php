							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="cnic" placeholder="Enter NID"value=<?php echo $row['cnic'] ?>>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="state" placeholder="Enter blood group" value=<?php echo $row['state'] ?>>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
