								...
								$count=0;
									...
									?>
										...
										<tr>
											...
											<td class="text-left"><?php echo "100" ?></td>
											<input type="hidden" name="total_marks[]" value="100" >
											<td><input type="text" name="obtain_marks[]" placeholder="Enter Obtained Marks" class="form-control"></td>
