					...
					<div class="col-md-12">
						...
						<form action="class-result.php" method="post">
							<div class="row mt-3">
								...
								<div class="col-md-4">
									<input type="submit" name="submit" class="btn btn-primary px-5" value="Go">
								</div>
							</div>
						</form>
					</div>
								...
								$count=0;
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="obtain_marks[]" placeholder="Enter Obtain Marks" class="form-control"></td>
