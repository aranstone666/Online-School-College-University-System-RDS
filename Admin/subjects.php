							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="subject_code" class="form-control" required placeholder="Enter Course Code" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">Course Name:</label>
										<input type="text" name="subject_name" class="form-control" required placeholder="Enter Course Name" required>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" name="credit_hours" class="form-control"  placeholder="Enter Course Credit Hours" required>
									</div>
								</div>
								<div class="col-md-6 mt-4">
									<div class="form-group pt-2">
										<input type="submit" name="sub" value="Add Course" class="btn btn-primary">
									</div>
								</div>
							</div>
						</form>
