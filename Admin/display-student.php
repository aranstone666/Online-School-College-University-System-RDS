...
<html lang="en">
	...
	while ($row=mysqli_fetch_array($run)) {
		?>
		<div class="container  mt-1 border border-muted mb-1">
			<div class="row text-white bg-secondary pt-5">
				<div class="col-md-4">
					<?php  $profile_image= $row["profile_image"] ?>
					<img class="ml-5 mb-5" height='260px' width='260px' src=<?php echo "images/$profile_image"  ?> >
				</div>
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>NID:</h5> <?php echo $row['cnic']  ?><br><br>
							<h5>NSU ID:</h5> <?php echo $row['roll_no']  ?><br><br>
						</div>
					</div>
				</div>
				<hr>
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>Applicant Type:</h5> <?php echo $row['form_b']  ?></div>
			</div>
			<div class="row pt-3">
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>SSC Complition Date:</h5> <?php echo $row['matric_complition_date']  ?></div>
				<div class="col-md-4"><h5>SSC Awarded Date:</h5> <?php echo $row['matric_awarded_date']  ?></div>
				<div class="col-md-4"><h5>SSC Certificate:</h5> <?php echo $row['matric_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>HSC Complition Date:</h5> <?php echo $row['fa_complition_date']  ?></div>
				<div class="col-md-4"><h5>HSc Awarded Date:</h5> <?php echo $row['fa_awarded_date']  ?></div>
				<div class="col-md-4"><h5>HSC Certificate:</h5> <?php echo $row['fa_certificate']  ?></div>
			</div>
			<div class="row pt-3">
