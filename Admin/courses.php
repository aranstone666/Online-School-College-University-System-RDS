		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Program Management System </h4>
				</div>
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="course_code" class="form-control" required placeholder="Enter Program Code">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="semester_or_year" class="form-control" required placeholder="Enter Semesters">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
