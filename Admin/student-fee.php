		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Student Tuition Fee Management System </h4>
				</div>
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										<label>Enter NSU ID:</label>
										<div class="d-flex">
											<input type="text" class="form-control" name="roll_no" placeholder="Enter NSU ID">
											<input type="submit" name="submit" class="btn btn-primary px-4 ml-4" value="Go">
										</div>
									</div>
								</div>
								...
								$i=1;
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="posting_date" class="form-control" placeholder="Enter Semester"></td>
