			...
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						...
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Results
						</a>
					</li>
					...
					<li class="nav-item">
						...
						<i class="fa fa-credit-card-alt mr-2" aria-hidden="true"></i> Fees
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-personal-information.php">
						<span data-feather="file"></span>
						<i class="fa fa-info-circle mr-2" aria-hidden="true"></i> Edit Your Profile
						</a>
					</li>
					<li class="nav-item">
